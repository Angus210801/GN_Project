...
class Ui_JX_FW(object):
    ...
    def getxpressversion(self):
        self.getxpressverison=getXpressVersionThread()
        self.getxpressverison.start()
    ...
    def setupUi(self, JX_FW):
        ...
        self.checkBox_case5664.clicked.connect(lambda:self.addCase(self.checkBox_case5664.text()))
        self.checkBox_case5665.clicked.connect(lambda:self.addCase(self.checkBox_case5665.text()))
    ...
    def retranslateUi(self, JX_FW):
        ...
        self.checkBox_case5664.setText(_translate("JX_FW", "case5664"))
        self.checkBox_case5664.setToolTip(_translate("JX_FW", "FW:leaveunchage;Setings:MAX value;JD install:Yes;Protect:Yes"))
        self.checkBox_case5509.setToolTip(_translate("JX_FW", "FW:higer version;Setings:leaveunchage;JD install:Yes;Protect:not"))
        self.checkBox_case5665.setText(_translate("JX_FW", "case5665"))
        self.checkBox_case5665.setToolTip(_translate("JX_FW", "FW:leaveunchage;Setings:MIN value;JD install:Yes;Protect:Yes"))
