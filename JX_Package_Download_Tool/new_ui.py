...
def run_testcase(testcase_function):
    print(f"Running testcase: {testcase_function}")
...
#         print(testcase_function)
#     def run(self):
#         print(f"Running testcase: {self.testcase_function}")
#         print("\n")
#         func = globals().get(self.testcase_function)
#         if func is not None and callable(func):
#             func()
#         else:
#             print(f"Function {self.testcase_function} not found or not callable.")
...
class TestcaseThread(multiprocessing.Process):
    ...
    def run(self):
        def print_to_queue(text):
            self.queue.put(text)

        sys.stdout.write = print_to_queue
...
class TestcaseApp(QWidget):
    ...
    #         if cb.isChecked():
    #             # Start the thread for this testcase
